...
def update():
    ...
    area_difference = 27460.0 - contour_area
    ...
    if cur_state == State.search:
        ...
        if contour_area != 0:
            ...
            if area_difference > 15000:
                speed = 0.30
            else:
                speed = 3 * area_difference * (1 / 15000)

                if speed > 0.30: speed = 0.30
                elif speed < -0.30: speed = -0.30 

            if abs(area_difference) < 10 and speed < 0.02:
                if abs(angle) > 0.20 and abs(area_difference) <15:
