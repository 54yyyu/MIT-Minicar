...
'''
    if contour_area != 0:
        #distance = 48.555459 + 133315.829 / contour_area
        distance = 6271.272 * contour_area ** -0.513
        print(distance)
        if distance !=0:
            speed = (speed_remap(rc_utils.clamp(distance, 0, 80), 0, 80, -1, 1))
        
        elif distance > 80:
            speed = (rc_utils.remap_range(rc_utils.clamp(distance, 0, 80), 0, 80, -0.3, 0.3))
        elif distance < 10:
            speed = (rc_utils.remap_range(rc_utils.clamp(distance, 0, 80), 0, 80, -0.1, 0))
        else:
            speed = (rc_utils.remap_range(rc_utils.clamp(distance, 0, 80), 0, 80, -0.1, 0.1))
